...
void RasterManager::draw_point(Point2D pos)
{
    int r = pos.color.r();
    int g = pos.color.g();
    int b = pos.color.b();
...
void RasterManager::draw_line(Point2D start, Point2D end)
{
    // brensenham
...
void RasterManager::draw_triangle(Point2D a, Point2D b, Point2D c)
{
