...
get_filename_component(prefix "${PROJECT_SOURCE_DIR}" ABSOLUTE)

set(exec_prefix "${prefix}")
set(bindir "${exec_prefix}/lib/SDL2")
set(libdir "${exec_prefix}/lib/SDL2")
set(includedir "${prefix}/lib/SDL2")

set_and_check(SDL2_PREFIX "${prefix}")
set_and_check(SDL2_EXEC_PREFIX "${exec_prefix}")
set_and_check(SDL2_BINDIR "${bindir}")
set_and_check(SDL2_INCLUDE_DIR "${includedir}")
